...
exports.makeHotAppCurrentWindowOnTop = (hotProcesses, maximize = true, logger) => {
...
exports.notifyUserAProcessNotFound = (matchedHotApp) => {
    switchMessage(enums_1.default.ERROR_NOTI, {
        title: text_1.default.errorTitle,
        message: text_1.default.processNotFound(matchedHotApp.name),
        hotApp: matchedHotApp
    });
};
exports.notifyUserNoHotMatchHotKey = (keycode, rawcode, matchedHotApp) => {
    if (process.platform == "darwin") {
        if (keycode >= 0 && keycode <= 9) {
            this.ipc.sendShowClient();
            switchMessage(enums_1.default.ERROR_NOTI, {
                title: text_1.default.errorTitle,
                message: text_1.default.noHotApp(keycode - 1),
                hotApp: matchedHotApp
            });
        }
    }
        ...
        if (rawcode >= 48 && rawcode <= 58) {
            ...
            switchMessage(enums_1.default.ERROR_NOTI, {
                title: text_1.default.errorTitle,
                message: text_1.default.noHotApp(rawcode - 48),
                hotApp: matchedHotApp
            });
        }
    }
